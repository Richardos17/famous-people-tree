...
import { ReactFlow, Background, Controls, addEdge, applyNodeChanges, applyEdgeChanges , MarkerType,type Node, type Edge, type OnConnect, type OnNodesChange, type OnEdgesChange, ConnectionMode } from '@xyflow/react';
...
export default function Home(){
  ...
  const [nodes, setNodes]= useState<Node[]>([
    {id:"1", data : {name: "Richard 1", birthDate: new Date(2014, 9, 9 ), deathDate: new Date(2014, 9, 19), imageLink: "https://storage.googleapis.com/media-newsinitiative/images/GO801_GNI_VerifyingPhotos_Card2_image3.original.jpg", wikipediaLink:"string", handlePosition: {verticalHandlePosition: VerticalHandlePosition.Top, horizontalHandlePosition: HorizontalHandlePosition.None}}, position: {x: 10, y:500}, type: "person"},
    {id:"2", data : {name: "Richard 2", birthDate: new Date(2014, 9, 9 ), deathDate: new Date(2014, 9, 19), imageLink: "https://storage.googleapis.com/media-newsinitiative/images/GO801_GNI_VerifyingPhotos_Card2_image3.original.jpg", wikipediaLink:"string", handlePosition: {verticalHandlePosition: VerticalHandlePosition.Bottom, horizontalHandlePosition: HorizontalHandlePosition.None}}, position: {x: 10, y:0}, type: "person"}
  ])
...
/*{
  ...
  function addParent(){
    //TODO create parent node and attach to child node

  }
  function addChild(){
    //TODO create child node and attach to parent node
  }
